...
const stages = [
  ...
  },
  {
    ...
    desc: 'L\'image Docker est taguee avec le numero de build et le hash du commit, puis poussee vers un registry Docker (local ou distant) pour etre disponible au deploiement.',
    tools: ['Docker Registry', 'localhost:5000', 'Semantic Versioning'],
    files: ['docker-compose.jenkins.yml'],
    details: 'Le tag combine numero de build et hash git (ex: 1-0294ec5). Cela permet d\'identifier precisement quel code tourne en production et de rollback si necessaire.',
  },
  {
